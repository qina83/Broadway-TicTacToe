...
use App\Identity\Infrastructure\DBAL\ExistingUserDBALRepository;
 ...
 */
class CreateExistingUserRMCommand extends Command
{
    private ExistingUserDBALRepository $repository;
    private Connection $connection;
    protected static $defaultName = 'app:read-model:existing-user:create';

    public function __construct(Connection $connection, ExistingUserDBALRepository $repository)
    {
        parent::__construct();
